...
class ChessboardMaterial(
    ...
    override fun shade(info: ShadingInfo): RgbColor {
        val material = selectMaterial(info)
        return material.shade(info)
    }

    override fun areaLightShade(info: ShadingInfo): RgbColor {
        val material = selectMaterial(info)
        return material.areaLightShade(info)
    }

    private fun selectMaterial(info: ShadingInfo): MatteMaterial {
        ...
        val material = if ((total % 2) == 0) material1 else material2
